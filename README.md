# Outbound Calls with IVR DTMF Collection and Bridging: Using EnableX Programmable Voice APIs
...
## Installation
- `git clone https://github.com/EnableX/voice-outbound-ivr-dtmf-bridge.git`
- `cd voice-outbound-ivr-dtmf-bridge`
- `npm install`
